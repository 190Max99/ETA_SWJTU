...
float eulerAngle_yaw_q = 0; // 四元数计算的旧yaw角，用于降低四元数的零漂
float offset = 0;        // 四元数的零漂
float offset_sum = 0;    // 四元数的零漂累积
uint16 offset_count = 0; // 四元数的零漂时间累计
float offset_final = 0;  // 四元数的零漂最终值
